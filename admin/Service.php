...
<body>
    ...
    <div id="main-body">
        ...
        <div id="user-navi">
            ...
            <li><a class="user-navi-item" href="#">Service</a></li>
                ...
                <?php
                    ...
                    if($result-> num_rows > 0) {
                        while ($row = $result-> fetch_assoc()) {
                            ...
                            $row["Email"] ."</td><td>". $row["Contact"] ."</td><td>".  $row["ZoomID"] ."</td><td>". $row["Date"] ."</td><td>". 
                            $row["Member_ID"] ."</td><td>";
                            ?> <form method="post" action="delete.php">
                                <input type="hidden" name="table" value="services">
                                <input type="hidden" name="delete" value="<?php echo $row["id"]; ?>">
                                <button type="submit" id="btnDelete">Delete</button>
								<a  id="btnEmail" href="https://outlook.live.com/calendar/0/view/agenda/quickcapture/moreDetails">Reminder </a>
                           </form> </td></tr> <?php
