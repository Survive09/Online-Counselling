...
<body>
    ...
    <div id = "main-body">
        ...
        <!-- user   Navigation bar  -->
        <div id="user-navi">
            <li><a id="user-navi-choose" href="#">My Details</a></li>
            <li><a class="user-navi-item" href="services.php">Services</a></li>
        </div>
 ...
 <!-- get data in data base *********************************************************************** -->
        <?php 
            ...
            $id = $_SESSION['councillor'];


            $sql = mysqli_query($conn,"SELECT * FROM counsellors WHERE id = $id");
        ...
        <!-- update form -->
            <div id="form-back">
                ...
                <form name="myForm" onsubmit="return validateForm()" method="post">
                    ...
                    <input id="email" placeholder="E-mail Address" type="text" name="ymail" value="<?php echo $result["Email"]; ?>"><br> ID No:
                    <input id="coun"  placeholder="ID Number" type="text" name="$IDno" value="<?php echo $result["Identity"]; ?>"> Contact Number:
        ...
        <!-- update form php part **************************************************************************** -->
                ...
                if (isset($_POST["btnSubmit"]))
                {
                    ...
                    $sql = "UPDATE `counsellors` SET `Firstname`='$firstName', `Lastname`='$lastName', `Email`='$email', 
                    `Country`='$contry', `Contact`=$tele, `Username`='$userName', 
